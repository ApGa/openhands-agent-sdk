...
def test_submodule_imports_work():
    ...
    assert ProgrammaticToolCallingTool is not None
...
def test_tools_module_has_expected_top_level_exports():
    ...
    assert openhands.tools.ProgrammaticToolCallingTool is not None
...
def test_from_import_works():
    ...
    from openhands.tools import (
        ProgrammaticToolCallingTool,  # noqa: F401
        TerminalTool,  # noqa: F401
    )
